      ...
      <div class="pt-6">
          ...
          <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <li>
              <div class="flex items-center">
                <a href="#" class="mr-2 text-sm font-medium text-black">Men</a>
            ...
            <li>
              <div class="flex items-center">
                <a href="#" class="mr-2 text-sm font-medium text-black">Clothing</a>
                <svg width="16" height="20" viewBox="0 0 16 20" fill="currentColor" aria-hidden="true" class="h-5 w-4 text-gray-300">
                  <path d="M5.697 4.34L8.98 16.532h1.327L7.025 4.341H5.697z" />
                </svg>
              </div>
            ...
            <li class="text-sm">
              <a href="#" aria-current="page" class="font-medium text-gray-900 hover:text-gray-500">Basic Tee 6-Pack</a>
            </li>
          </ol>
        </nav>
        ...
        <div class="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          <div class="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
            <h1 class="text-3xl font-serif font-bold tracking-tight text-black sm:text-3xl">Basic Tee 6-Pack</h1>
          </div>
    
          <div class="mt-4 lg:row-span-3 lg:mt-0">
            <h2 class="sr-only">Product information</h2>
            <p class="text-3xl tracking-tight text-black">$192</p>
    
            <div class="mt-6">
              <h3 class="sr-only text-black">Reviews</h3>
              <div class="flex items-center">
                <div class="flex items-center">
                ...
                <p class="sr-only text-gray-900">4 out of 5 stars</p>
                <a href="#" class="ml-3 text-sm font-medium text-blue-900 hover:text-indigo-500">117 reviews</a>
              </div>
            </div>
    
            <form class="mt-10">
              <div>
                <h3 class="text-sm font-medium text-black">Color</h3>
    
                <fieldset class="mt-4">
                  <legend class="sr-only text-gray-900">Choose a color</legend>
              ...
              <div class="mt-10">
                <div class="flex items-center justify-between">
                  ...
                  <a href="#" class="text-sm font-medium text-gray-900 hover:text-gray-500">Size guide</a>
                </div>
    
                <fieldset class="mt-4">
                  <legend class="sr-only text-gray-900">Choose a size</legend>
              ...
              <button type="submit" class="mt-10 font-sans flex w-full items-center justify-center rounded-md border border-transparent bg-blue-500 px-8 py-3 text-base font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2">Add to bag</button>
            </form>
          </div>
    
          <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
            <div>
              <h3 class="sr-only font-bold text-black">Description</h3>
            ...
            <div class="mt-10">
              <h3 class="text-sm font-bold text-black">Highlights</h3>
    
              <div class="mt-4">
                <ul role="list" class="list-disc space-y-2 pl-4 text-sm">
                  <li class="text-gray-400"><span class="text-gray-900">Hand cut and sewn locally</span></li>
                  <li class="text-gray-400"><span class="text-gray-900">Dyed with our proprietary colors</span></li>
                  <li class="text-gray-400"><span class="text-gray-900">Pre-washed &amp; pre-shrunk</span></li>
                  <li class="text-gray-400"><span class="text-gray-900">Ultra-soft 100% cotton</span></li>
                </ul>
              </div>
            </div>
    
            <div class="mt-10">
              <h2 class="text-sm font-bold text-black">Details</h2>
    
              <div class="mt-4 space-y-6">
                <p class="text-sm text-gray-900">The 6-Pack includes two black, two white, and two heather gray Basic Tees. Sign up for our subscription service and be the first to get new, exciting colors, like our upcoming &quot;Charcoal Gray&quot; limited release.</p>
              </div>
            </div>
          </div>
        </div>
