...
const DestinationDetail = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost/ub_back/wp-json/wp/v2/destination/${id}`)
      .then((res) => {
    ...
    axios
      .get(`http://localhost/ub_back/wp-json/wp/v2/posts/`)
      .then((res) => {
        setBlogs(res.data);
      })
      .catch((err) => {
  ...
  const handleVisitNav = (destination:any) => {
  ...
  return (
    <>
              ...
              <div className="mt-10">
                ...
                <div className="mt-4">
                  <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
                    {destination?.ACF?.Highlights?.map((item) => (
      ...
      <TopItems data={blogs} heading="Related Blogs" />
    </>
  );
};
